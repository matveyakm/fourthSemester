...
let ``evaluate Number 5 should return 5`` () =
    ...
    evaluate (Number 5) |> should equal (Some 5)
...
let ``evaluate Number 0 should return 0`` () =
    ...
    evaluate (Number 0) |> should equal (Some 0)
...
let ``evaluate Number -10 should return -10`` () =
    ...
    evaluate (Number -10) |> should equal (Some -10)
...
let ``evaluate Add(3, 5) should return 8`` () =
    ...
    evaluate (Add (Number 3, Number 5)) |> should equal (Some 8)
...
let ``evaluate nested Add should return sum`` () =
    ...
    evaluate (Add (Add (Number 1, Number 2), Number 3)) |> should equal (Some 6)
...
let ``evaluate Sub(10, 3) should return 7`` () =
    ...
    evaluate (Sub (Number 10, Number 3)) |> should equal (Some 7)
...
let ``evaluate Sub(5, 10) should return -5`` () =
    ...
    evaluate (Sub (Number 5, Number 10)) |> should equal (Some -5)
...
let ``evaluate Mul(4, 5) should return 20`` () =
    ...
    evaluate (Mul (Number 4, Number 5)) |> should equal (Some 20)
...
let ``evaluate nested Mul should return product`` () =
    ...
    evaluate (Mul (Mul (Number 2, Number 3), Number 4)) |> should equal (Some 24)
...
let ``evaluate Div(20, 4) should return 5`` () =
    ...
    evaluate (Div (Number 20, Number 4)) |> should equal (Some 5)
...
let ``evaluate Div(7, 2) should return 3 (integer division)`` () =
    ...
    evaluate (Div (Number 7, Number 2)) |> should equal (Some 3)
...
let ``evaluate (2 + 3) * 4 should return 20`` () =
    ...
    evaluate (Mul (Add (Number 2, Number 3), Number 4)) |> should equal (Some 20)
...
let ``evaluate (10 - 2) * 3 should return 24`` () =
    ...
    evaluate (Mul (Sub (Number 10, Number 2), Number 3)) |> should equal (Some 24)
...
let ``evaluate 10 - 2 * 3 should return 4 (without parentheses, left-to-right)`` () =
    ...
    evaluate (Sub (Number 10, Mul (Number 2, Number 3))) |> should equal (Some 4)
...
let ``evaluate (10 + 5) / 3 should return 5`` () =
    ...
    evaluate (Div (Add (Number 10, Number 5), Number 3)) |> should equal (Some 5)
...
let ``evaluate complex: ((2 + 3) * (4 - 1)) / 5 should return 3`` () =
    ...
    evaluate (Div (Mul (Add (Number 2, Number 3), Sub (Number 4, Number 1)), Number 5)) |> should equal (Some 3)

/// <summary>
/// Tests for division by zero handling.
/// </summary>
[<Test>]
let ``evaluate Div(10, 0) should return None`` () =
    /// <param name="expr">Division by zero expression</param>
    evaluate (Div (Number 10, Number 0)) |> should equal None

/// <summary>
/// Tests for tail-recursive division by zero handling.
/// </summary>
[<Test>]
let ``evaluateTailRecursive Div(10, 0) should return None`` () =
    /// <param name="expr">Tail recursive division by zero</param>
    evaluateTailRecursive (Div (Number 10, Number 0)) |> should equal None
...
let ``evaluateTailRecursive Number 42 should return 42`` () =
    ...
    evaluateTailRecursive (Number 42) |> should equal (Some 42)
...
let ``evaluateTailRecursive Add(5, 3) should return 8`` () =
    ...
    evaluateTailRecursive (Add (Number 5, Number 3)) |> should equal (Some 8)
...
let ``evaluateTailRecursive Sub(10, 4) should return 6`` () =
    ...
    evaluateTailRecursive (Sub (Number 10, Number 4)) |> should equal (Some 6)
...
let ``evaluateTailRecursive Mul(6, 7) should return 42`` () =
    ...
    evaluateTailRecursive (Mul (Number 6, Number 7)) |> should equal (Some 42)
...
let ``evaluateTailRecursive Div(20, 4) should return 5`` () =
    ...
    evaluateTailRecursive (Div (Number 20, Number 4)) |> should equal (Some 5)
...
let ``evaluateTailRecursive complex: ((2 + 3) * (4 - 1)) + 10 should return 25`` () =
    ...
    evaluateTailRecursive (Add (Mul (Add (Number 2, Number 3), Sub (Number 4, Number 1)), Number 10)) |> should equal (Some 25)